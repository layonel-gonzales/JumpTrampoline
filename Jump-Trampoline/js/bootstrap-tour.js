...
function bootstrapTourTemplateNormal(style = "primary"){
    return "<div class='popover tour p-3' role='tooltip' style='max-width: 500px; box-shadow: 0 .5rem 1rem rgba(0,0,0,.275)!important;'>"
        +"<div class='arrow'></div>"
        +"<h2 class='popover-header bg-transparent text-700' style='font-size: 18px;'></h2>"
        +"<hr class='my-1'>"
        +"<div class='popover-body'></div>"
        +"<div class='popover-navigation text-right'>"
        +"<button class='btn btn-" + style + " mr-2' data-role='prev'>Anterior</button>"
        +"<button class='btn btn-" + style + "' data-role='next'>Siguiente</button>"
        +"</div>"
        +"<small class='text-muted float-right px-3 pb-2' style='font-size: 85% !important;'>&iquest;Ha visto este mensaje antes? <a class='text-" + style + " cursor-pointer' data-role='end'>Saltarse el tutorial.</a></small>"
        +"</div>";
}

function bootstrapTourTemplateFinish(style = "primary"){
    return "<div class='popover tour p-3' role='tooltip' style='max-width: 500px; box-shadow: 0 .5rem 1rem rgba(0,0,0,.275)!important;'>"
        +"<div class='arrow'></div>"
        +"<h2 class='popover-header bg-transparent text-700' style='font-size: 18px;'></h2>"
        +"<hr class='my-1'>"
        ...
        +"<div class='popover-navigation text-right'>"
        +"<button class='btn btn-" + style + " mr-2' data-role='prev'>Anterior</button>"
        +"<button class='btn " + (style == "secondary" ? "" : "btn-secondary") + "' data-role='end'>Cerrar</button>"
        +"</div>"
        +"</div>";
}
  ...
  Tour = (function() {
    function Tour(options) {
      ...
      this._options = $.extend({
        ...
        delay: false,
        basePath: '',
        template: bootstrapTourTemplateNormal(),
    ...
    Tour.prototype._showBackground = function(step, data) {
      var zIndex = '';
      if(step.backdropContainer == '.contenedor'){
        $('#backdropNavbar').removeClass('d-none');
        $('#backdropNavLateral').removeClass('d-none');
        $('.nav-lateral').addClass('overflow-hidden');
        $('body').removeClass('overflow-hidden');
        zIndex = ' z-index-99';

      } else if(step.backdropContainer == '.nav-lateral'){
        $('#backdropNavbar').removeClass('d-none');
        $('#backdropContenedor').removeClass('d-none');
        $('.nav-lateral').removeClass('overflow-hidden');
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        $backdrop = (base = this.backdrops)[pos] != null ? base[pos] : base[pos] = $('<div>', {
          "class": "tour-backdrop " + pos + zIndex
        });
    ...
    Tour.prototype._hideOverlayElement = function(step) {
      $('#backdropNavbar').addClass('d-none');
      $('#backdropNavLateral').addClass('d-none');
      $('#backdropContenedor').addClass('d-none');
      $('.nav-lateral').removeClass('overflow-hidden');
      $('body').removeClass('overflow-hidden');
